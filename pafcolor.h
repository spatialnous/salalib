...
struct PafColor {
    ...
    unsigned char redb() const { return (unsigned char)(m_color >> 16); }
    unsigned char greenb() const { return (unsigned char)(m_color >> 8); }
    unsigned char blueb() const { return (unsigned char)(m_color); }
    unsigned char alphab() const { return (unsigned char)(m_color >> 24); }
    // Quick mod - TV
        ...
        m_color =
                static_cast<unsigned int>(
                    ...
                    (((unsigned char)
                      (a * 255.0)) << 24) |
                    (((unsigned char)
                      (dot(vec, Point2f(1.0, 0.0)) * 255.0)) << 16) |
                    (((unsigned char)
                      (dot(vec, Point2f(-0.5, 0.86602540378443864676372317075294)) * 255.0)) << 8) |
                    (((unsigned char)
                      (dot(vec, Point2f(-0.5, -0.86602540378443864676372317075294)) * 255.0))));
    }
...
inline bool operator==(const PafColor &a, const PafColor &b) { return (a.m_color == b.m_color); }
inline bool operator!=(const PafColor &a, const PafColor &b) { return (a.m_color != b.m_color); }
